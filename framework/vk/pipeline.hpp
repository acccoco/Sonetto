...
template<size_t N>
void GraphicsPipelineTemplate::vertex_input_binding_set(
        const std::array<vk::VertexInputBindingDescription, N>& bindings)
{
...
template<size_t N>
void GraphicsPipelineTemplate::vertex_input_attribute_set(
